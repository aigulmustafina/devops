...
```bash
mkdir -p /etc/certs /etc/pki/nginx/
curl -o /etc/certs/track-devops.crt https://stepik.org/media/attachments/lesson/686238/track-devops.crt
curl -o /etc/certs/track-devops.key https://stepik.org/media/attachments/lesson/686238/track-devops.key
...
server {
    ...
    ssl_certificate     /etc/certs/track-devops.crt;
    ssl_certificate_key /etc/certs/track-devops.key;
